...
if 'PYTHONANYWHERE_SITE' in os.environ:   # CH was if 'PYTHONANYWHERE_SITE' is os.environ: which is never True!!!
...
def plot_map():
    ...
    if request.method == "POST":
        ...
        #map_file_name = f"tracemyroute/templates/map_{timestamp}.html"  # for pythonanywhere # CH: No! the chdir for PA takes care of that!
        map.save(map_file_name)

        # delete any previous version of map.html
        for file in os.listdir("templates"):
        #for file in os.listdir("tracemyroute/templates"):    # for pythonanywhere # CH: No! the chdir for PA takes care of that!
